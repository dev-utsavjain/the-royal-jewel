...
func createServer() *http.Server {
	...
	// CORS must run first so every response (including panics / aborts) carries CORS headers.
	r.Use(middleware.CORSMiddleware())

	// Short-circuit any OPTIONS preflight that slips past the CORS middleware.
